function [m1,m2,fail]=crossover(m1,m2,gen_param)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    while correct==0 && count<gen_param.maxtries
        %% Extracting subtrees
        [m1,sm1,n]=extract_subtree(m1,gen_param.mutmindepth,gen_param.maxdepth,gen_param.maxdepth); %% check extract_subtree comments
        [m2,sm2,n2]=extract_subtree(m2,gen_param.mutmindepth,n,gen_param.maxdepth-n+1);
        count=count+1;
    ...
    if correct==0
        ...
        if gen_param.preevaluation
            ...
            f=peval;
            preevok1=feval(f,m1,gen_param);
            preevok2=feval(f,m2,gen_param);
