...
%  
%   Ex:
%   TOY=MLC;TOY.go(3); % computes 3 generations for the "toy_problem"
%   TOY=MLC;TOY.go(13,1); % computes 13 generations for the "toy_problem"
%   with graphical output
%   LOR=MLC('GP_lorenz');LOR.go(2) % computes 2 generations of the "Lorenz Problem"
%
%   MLC properties:  
